...
<body style="background-image: url('/Elements/jungle-background.png');">
    <nav class="navbar navbar-expand-lg" style="background-color: #178f05; background:linear-gradient(to bottom, #0d5520 5%, #3a990a 100%);">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" style="color:white;" href="/Pages/Home.php">Home</a>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <?php if (! isset($_SESSION['user'])) {?>
                                <a class="btn" style="background-color: #22ff00; background:linear-gradient(to bottom, #16a33c 5%, #5bdf19 100%); color:white;" href="/Pages/User/Cadastro.html" role="button">Cadastra-se</a>
                                <a class="btn" style="background-color: #1b0fc7; background:linear-gradient(to bottom, #1622c2 5%, #0f4ed8 100%); color:white;" href="/Pages/User/Login.html" role="button">Login</a>
                            <?php }else{ ?>
                                <a href="/Controllers/Logout.php" class="btn" style="background-color: #1b0fc7; background:linear-gradient(to bottom, #1622c2 5%, #0f4ed8 100%); color:white;">Sair</a>
                            <?php }?>
                        </li>
                    </ul>
                </div>
                ...
                <?php
                    if(isset($_FILES['pic'])){
                        ...
                        echo '<div class="alert alert-success" role="alert" align="center">
                                ...
                                <br>
                                <a href="/Pages/Home.php"><button class="btn btn-default">Enviar nova imagem</button></a>
                                </div>';
